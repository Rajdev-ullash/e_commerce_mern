            ...
            .then((data) => {
              ...
              if (data.errors) {
                if (data.errors.email) {
                  toast.error(data.errors.email.msg, {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
                ...
                if (data.errors.password) {
                  toast.error(data.errors.password.msg, {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
            ...
            .catch(function (error) {
              ...
              if (error.response) {
                ...
                if (error.response.data.errors.password) {
                  toast.error(error.response.data.errors.password.msg, {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
              ...
              <div class="form-group">
                ...
                >
                  <i
                    ...
                    class={repasswordShown ? "fas fa-eye-slash" : "fas fa-eye"}
                  ></i>
                </span>
              </div>
              <div class="form-group">
