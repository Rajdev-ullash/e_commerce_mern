...
const ManageSubCategory = () => {
  ...
  const deleteSubCategory = (slug) => {
    fetch(`http://localhost:5000/api/subCategory/deleteSubCategory/${slug}`, {
      method: "DELETE",
      headers: {
  ...
  useEffect(() => {
    setLoader(true);
    fetch("http://localhost:5000/api/subCategory/allSubCategory", {
      method: "GET",
      headers: {
        Authorization: `Bearer ${tokenData}`,
        Accept: "application/json",
                    ...
                    <tr>
                      ...
                      <td>
                        <ul class="action-list">
                          <li>
                            <Link
                              to={`/admin/editSubCategory/${manage.slug}`}
                          ...
                          <li>
                            <Link class="btn btn-danger link_custom">
                              <i
                                onClick={() => deleteSubCategory(manage.slug)}
                                class="fa fa-times"
                              ></i>
                            </Link>
                          </li>
